...
const AUTH_BASE = process.env.REACT_APP_AUTH_URL || '/api/auth';
const PROJECT_BASE = process.env.REACT_APP_PROJECT_URL || '/api/projects';
const INTERACTION_BASE = process.env.REACT_APP_INTERACTION_URL || '/api/interactions';
const NOTIFICATION_BASE = process.env.REACT_APP_NOTIFICATION_URL || '/api/notifications';
